    ...
    public class controleFuncionario
    {
        ...
        public void CadastrarFuncionario(List<String> dadosFuncionario)
        {
            ...
            if (validarfuncionario.mensagem.Equals(""))
            {
                ...
                funcionario.endereco = dadosFuncionario[8];
                funcionario.numero = dadosFuncionario[9];
                funcionario.complemento = dadosFuncionario[10];
                funcionario.cidade = dadosFuncionario[11];
                funcionario.bairro = dadosFuncionario[12];
                funcionario.estado = dadosFuncionario[13];
                funcionario.cep = dadosFuncionario[14];
                funcionario.email = dadosFuncionario[15];
                funcionario.celular = dadosFuncionario[16];
                funcionario.telefone = dadosFuncionario[17];
